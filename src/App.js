...
const App = () => {
  const portfolioData = {
    ...
    skills: ["Cloud Practitioner","Proficient in Java & C++", "MERN Web Developer", "Intermediate in Database(mySQL & MongoDB)"],
    projects: [
      {
      ...
      {
        title: "Harsh Jain | Portfolio Website",
